...
var _user$project$Routing$toPath = function (route) {
	...
	switch (_p0.ctor) {
		case 'HomeIndexRoute':
			return '/';
		case 'GameShowRoute':
			return A2(_elm_lang$core$Basics_ops['++'], '/game/', _p0._0);
		case 'GameErrorRoute':
			return '/game-error';
		default:
			return '/not-found';
...
var _user$project$Routing$GameErrorRoute = {ctor: 'GameErrorRoute'};
var _user$project$Routing$GameShowRoute = function (a) {
	return {ctor: 'GameShowRoute', _0: a};
};
var _user$project$Routing$HomeIndexRoute = {ctor: 'HomeIndexRoute'};
var _user$project$Routing$routeParser = _evancz$url_parser$UrlParser$oneOf(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			A2(
			_evancz$url_parser$UrlParser$format,
			_user$project$Routing$GameShowRoute,
			A2(
				_evancz$url_parser$UrlParser_ops['</>'],
				_evancz$url_parser$UrlParser$s('contacts'),
				_evancz$url_parser$UrlParser$string))
		]));
var _user$project$Routing$pathParser = function (location) {
	return A3(
		_evancz$url_parser$UrlParser$parse,
		_elm_lang$core$Basics$identity,
		_user$project$Routing$routeParser,
		A2(_elm_lang$core$String$dropLeft, 1, location.pathname));
};
var _user$project$Routing$parser = _elm_lang$navigation$Navigation$makeParser(_user$project$Routing$pathParser);

var _user$project$Model$initialModel = function (route) {
	return {phoenixSocket: _elm_lang$core$Maybe$Nothing, route: route};
};
var _user$project$Model$Model = F2(
	function (a, b) {
		return {phoenixSocket: a, route: b};
	});
...
var _user$project$View$indexView = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[]),
	_elm_lang$core$Native_List.fromArray(
...
var _user$project$View$page = function (model) {
	var _p0 = model.route;
	return _user$project$View$indexView;
};
...
var _user$project$Main$init = function (result) {
	...
	return A2(
		...
		result,
		_user$project$Model$initialModel(currentRoute));
};
